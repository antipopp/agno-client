...
import type { ImageData } from '@antipopp/agno-types';
...
```tsx
import type { VideoData } from '@antipopp/agno-types';
...
```tsx
import type { AudioData, ResponseAudioData } from '@antipopp/agno-types';
